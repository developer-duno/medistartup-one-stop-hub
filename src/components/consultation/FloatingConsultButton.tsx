  ...
  return (
    <div 
      className={cn(
        ...
        selectedExperts.length === 0 ? "scale-0 opacity-0" : "scale-100 opacity-100"
      )}
    >
      <button
      ...
      >
        <span className="absolute right-full top-1/2 transform -translate-y-1/2 -translate-x-2 bg-white text-accent text-xs font-bold rounded-full h-6 w-6 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
